= Opush 3.1.1 Administration Guide
...
|Motorola (Android 4.4.4)	|Moto G		|[green]#YES# http://ci-obm.linagora.com/jira/browse/OP-185[(OP-185)]	|[green]#YES#	|[green]#YES#	
...
Be aware that users with Android (> 4.4) have https://ci-obm.linagora.com/jira/browse/OP-185[limitations on address books synchronization]. 
