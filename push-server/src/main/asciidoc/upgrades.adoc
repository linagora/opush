...
[WARNING]
====
Every synchronized device will forget its OBM data, synchronization states will be reinitialized from scratch
====
...
|http://ci-obm.linagora.com/jira/browse/OP-184[OP-184]|Faster synchronization thanks to a SQL query improvement 
