...
public class MailboxFetchAPITest {
	...
	public void setUp() {
	    ...
	    this.testUtils = new MailboxTestUtils(mailboxService, udr, mailbox, beforeTest, smtpServerSetup);
	}
	...
	public void testFetchEnvelope() throws MailException {
		...
		Collection<UIDEnvelope> uidEnvelopes = mailboxService.fetchEnvelope(udr, MailboxPath.of(EmailConfiguration.IMAP_INBOX_NAME), MessageSet.singleton(1l));
	...
	public void testFetchEnvelopeWithWrongUID() throws MailException {
		...
		mailboxService.fetchEnvelope(udr, MailboxPath.of(EmailConfiguration.IMAP_INBOX_NAME), MessageSet.singleton(2l));
	}
	...
	public void testFetchEnvelopeMsgnoDifferentThanUID() throws MailException, ImapMessageNotFoundException {
		...
		MailboxPath mailboxPath = MailboxPath.of(EmailConfiguration.IMAP_INBOX_NAME);
	...
	public void testFetchFastNoUid() throws MailException {
		MailboxPath inbox = MailboxPath.of(EmailConfiguration.IMAP_INBOX_NAME);
	...
	public void testFetchUIDNextMailboxInUTF7() {
		...
		MailboxPath mailbox = MailboxPath.of("JIRA INBOX");
	...
	public void testFetchUIDNextMailboxInUTF7WithAccent() {
		...
		MailboxPath mailbox = MailboxPath.of("déplacements");
