...
public class SyncCollectionCommandResponse implements TypedCommand {
	...
	public static class Builder {
		...
		public SyncCollectionCommandResponse build() {
			return new SyncCollectionCommandResponse(status, type, serverId, clientId, applicationData);
		}
	}
	...
	protected SyncCollectionCommandResponse(SyncStatus status, SyncCommand type, ServerId serverId, String clientId, IApplicationData applicationData) {
		this.type = type;
		this.serverId = serverId;
		this.clientId = clientId;
		this.status = status;
