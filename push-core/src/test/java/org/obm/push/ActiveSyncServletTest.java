...
public class ActiveSyncServletTest {
	...
	private ActiveSyncServlet createActiveSyncServlet(UserDataRequest userDataRequest) throws DaoException, IOException {
		...
		return new ActiveSyncServlet(sessionService, continationService, backend, deviceService, policyService, responderFactory, handlers, loggerService, logger, httpErrorResponder);
	}
}
